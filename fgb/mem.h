...
#define MAX_RAM_BANK 2 // force dmg // 8
#define MAX_CART_RAM_BANK 1 // *8k

struct ram
{
	byte hi[256];
	byte ibank[MAX_RAM_BANK][4096]; // internal gb ram, dmg 2x4k
	byte sbank[MAX_CART_RAM_BANK][ 8192 ]; // cartridge ram, 8k max here
	//byte * sbank;
	int loaded;
};
